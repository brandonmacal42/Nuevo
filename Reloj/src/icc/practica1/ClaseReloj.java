...
/**
 * Clase para representar un Reloj.
 * <p>
 *
 * Un objeto de la clase ClaseReloj implementa todos los métodos de la clase
 * Reloj, por lo que es capaz de definir su hora y darla, además de avanzar (o
 * retroceder) por segundos, minutos u horas.
 * 
 * @author Canek
 */
public class ClaseReloj implements Reloj {
  ...
  /**
   * Constructor simple. Regresa un Reloj con la hora actual del sistema.
   */
  public ClaseReloj() {
    this.ponTiempo();
  }
  ...
  /**
   * Pone el tiempo del Reloj como el tiempo del sistema al momento de llamar esta
   * función.
   */
  ...
  /**
   * Pone únicamente la hora del Reloj, cuidando que esté en el rango 0-11.
   * 
   * @param hora la nueva hora.
   */
  ...
  /**
   * Pone únicamente el minuto del Reloj, cuidando que esté en el rango 0-59.
   * 
   * @param minuto el nuevo minuto.
   */
  ...
  /**
   * Pone únicamente el segundo del Reloj, cuidando que esté en el rango 0-59.
   * 
   * @param segundo el nuevo segundo.
   */
  ...
  /**
   * Avanza el Reloj en un segundo. Si al avanzar el segundo se pasa de 59,
   * regresa el segundo a 0 y avanza el minuto en uno. Si al avanzar el minuto
   * pasa de 59, avanza la hora en uno. Y si al avanzar la hora pasa de 11, la
   * regresa a 0.
   */
  ...
  /**
   * Avanza el Reloj en un minuto. Si al avanzar el Reloj en un minuto pasa de 59,
   * avanza la hora en uno. Y si al avanzar la hora pasa de 11, la regresa a 0.
   */
  ...
  /**
   * Avanza el Reloj en una hora. Si al avanzar la hora pasa de 11, la regresa a
   * 0.
   */
