...
/**
 * <p>
 * La clase UsoReloj sirve (como su nombre indica), para hacer uso de los tipos
 * Reloj y VistaReloj, definidos por las interfaces respectivas.
 * <p>
 * Sólo tiene una función, <code>main</code>, donde se hace uso de las clases
 * ClaseReloj y VistaRelojAnalogico.
 * 
 * @author Canek
 * @author BlackZafiro
 */
