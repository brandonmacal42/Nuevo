 ...
 * Todo programa de Java se encuentra de una construcción llamada
 * <code>class</code>.
 */
public class Entrada {
	 ...
	 * 
	 * @param args Esta variable permite acceder a cada argumento. Los argumentos
	 *             son cadenas de caracteres <code>String</code>.
	 */
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			/*
			 * Para usar colores en una consola de Linux se usan códigos como '\033[35m'
			 * ('\003' ó '\e' son códigos para 'escape'). Si quieres jugar con ellos
